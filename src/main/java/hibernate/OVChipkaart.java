...
public class OVChipkaart {
    ...
    public void setKaart_nummer(Long identifier) {
        this.kaart_nummer = identifier;
    }
...
//    private ArrayList<Product> productlist;
    ...
    public OVChipkaart(Long kaart_nummer, Date geldig_tot, int klasse, double saldo, int reiziger_id) {
